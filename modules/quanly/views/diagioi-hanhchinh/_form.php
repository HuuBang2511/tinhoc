...
<div class="block block-themed">
    ...
    <div class="block-content">
        ...
        <?= Html::hiddenInput('DiagioiHanhchinh[geom_text]', $model->geom_text, ['id' => 'geom_text']) ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <?= $form->field($model, 'ma_diagioi_hanhchinh')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-6">
                <?= $form->field($model, 'tong_dientich')->textInput(['maxlength' => true]) ?>
            </div>
