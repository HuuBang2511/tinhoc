...
<div class="block block-themed">
    ...
    <div class="block-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <?= $form->field($model, 'caytrongcanhtac_id')->widget(Select2::className(), [
                        'data' => ArrayHelper::map($categories['vungcaytrong'], 'id', 'ten_vung'),
                        'options' => ['prompt' => 'Chọn vùng cây trồng'],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                ]) ?>
