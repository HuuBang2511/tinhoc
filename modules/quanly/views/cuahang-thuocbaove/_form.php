...
<div class="block block-themed">
    <div class="block-header">
        <h3 class="block-title">
            <?= ($model->isNewRecord) ? 'Thêm mới cửa hàng thuốc bảo vệ' : 'Cập nhật cửa hàng thuốc bảo vệ' ?>
        </h3>
    </div>

    <div class="block-content">

        <h2 class="content-heading text-uppercase">Cửa hàng thuốc bảo vệ</h2>

        <div class="row">
            <div class="col-lg-6">
                <?= $form->field($model, 'ten_cua_hang')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-3">
                <?= $form->field($model, 'phuongxa_id')->widget(DepDrop::classname(), [
                        ...
                        'pluginOptions' => [
                            ...
                            'url' => Url::to(['/quanly/cuahang-thuocbaove/phuongxa'])
                        ]
                    ]); ?>
            </div>
            <div class="col-lg-3">
                <?= $form->field($model, 'quanhuyen_id')->widget(DepDrop::classname(), [
                        ...
                        'pluginOptions' => [
                            ...
                            'url' => Url::to(['/quanly/cuahang-thuocbaove/quanhuyen'])
                        ]
                    ]); ?>
            </div>
            <div class="col-lg-3">
