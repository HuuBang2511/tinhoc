    ...
    <div class="col-lg-12">
        <div class="block block-themed">
            <div class="block-header">
                <h3 class="block-title">Thông tin nông hộ</h3>
            ...
            <div class="block-content tab-content">
                <div class="tab-pane active" id="thongtinnocgia-view">
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered">
                                <tr>
                                    <th style="width:35%"><?= $model->getAttributeLabel('ma_nong_ho')?></th>
                                    <td><?= $model->ma_nong_ho?></td>
                                </tr>
                                <tr>
                                    <th style="width:35%"><?= $model->getAttributeLabel('chunongho_ten')?></th>
                                    <td><?= $model->chunongho_ten ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?= Yii::$app->homeUrl ?><?= $model->url_hinhanh ?>" width="100%" height="550px"/></td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <h3> Diễn biến dịch bệnh của nông hộ</h3>
                            <a href="<?= Yii::$app->homeUrl ?>quanly/dienbien-dichbenh/create-dichbenh-nongho?id=<?= $_GET['id'] ?>"
                            class="btn btn-block btn-success mb-3 float-end">Thêm thông tin diễn biến dịch bệnh thuộc nông hộ</a>
                            <table class="table table-bordered">
                                <tr>
                                    <th>Vùng canh tác</th>
                                ...
                                <?php foreach($dienbien as $i => $item): ?>
                                <tr>
                                    <td><?= ($item->caytrongcanhtac_id != null) ? $item->caytrongcanhtac->ten_vung : '' ?></td>
                                    <td><?= ($item->dientich_nhiembenh!= null) ? $item->dientich_nhiembenh.' m&sup2' : '' ?></td>
                                    <td><?= ($item->thoi_diem != null) ? $item->thoi_diem : '' ?></td>
                                    <td class="text-center">
                                        <a
                                            href="<?= Yii::$app->homeUrl ?>quanly/dienbien-dichbenh/view?id=<?= $item->id ?>" role = 'modal-remote'>
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a
                                            href="<?= Yii::$app->homeUrl ?>quanly/dienbien-dichbenh/update-dichbenh-nongho?id=<?= $item->id ?>">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a
                                            href="<?= Yii::$app->homeUrl ?>quanly/dienbien-dichbenh/delete?id=<?= $item->id ?>"  data-toggel = 'tooltip', data-confirm="Xóa thông tin diễn biến dịch bênh">
...
<script type="module">
    ...
    var map = L.map('map').setView([<?= ($model->geo_y != null) ? $model->geo_y : '9.60802790773281' ?>, <?= ($model->geo_x != null) ? $model->geo_x : '105.98158836364748' ?>],20);
